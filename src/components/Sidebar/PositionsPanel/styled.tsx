...
const PositionItemPanel = styled.span<{
  ...
  width: ${(props) => (props.noOpen === 'tradebox' ? '121px' : '100%')};
  min-width: ${(props) => (props.noOpen === 'tradebox' ? '121px' : '')};
  margin-right: ${(props) => (props.noOpen === 'tradebox' ? '2%' : '')};
  margin-bottom: ${(props) => (props.noOpen === 'tradebox' ? '10px' : '5px')};
  margin-top: ${(props) => (props.noOpen === 'tradebox' ? '10px' : '')};
  position: relative;
  display: block;
  box-sizing: border-box;
  background: ${(props) =>
    props.noOpen !== 'tradebox' && props.opened
  ...
  &:before {
    ...
    background-color: ${(props) =>
      (props.noOpen !== 'tradebox' && props.selected) || props.isInGroup
  ...
  &:hover {
    outline: 1px solid
      ${(props) => props.noOpen !== 'tradebox' && props.colors.primary};
  }
`
