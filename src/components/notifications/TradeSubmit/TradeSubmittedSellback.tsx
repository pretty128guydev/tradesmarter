...
interface ITradeSubmittedSellback {
  showConfetti: boolean
  notification: INotification<any>
}

const TradeSubmittedSellback = (props: ITradeSubmittedSellback) => {
...
export default connect(mapStateToProps, {})(TradeSubmittedSellback)
